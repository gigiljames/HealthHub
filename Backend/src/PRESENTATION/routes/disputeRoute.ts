...
export class DisputeRoute {
  ...
  private _setRoutes() {
    ...
    this.disputeRouter.post(
      ...
      (req, res, next) => injectedDisputeController.submitDispute(req, res, next),
    );
    ...
    this.disputeRouter.get(
      ...
      authMiddleware([Roles.USER, Roles.DOCTOR], tokenService, authRepository),
      (req, res, next) => injectedDisputeController.getAppointmentDispute(req, res, next),
    );
    ...
    this.disputeRouter.post(
      ...
      authMiddleware([Roles.USER, Roles.DOCTOR], tokenService, authRepository),
      (req, res, next) => injectedDisputeController.getDisputeEvidenceUploadSignedUrl(req, res, next),
    );
    ...
    this.disputeRouter.get(
      ...
      (req, res, next) => injectedDisputeController.getAdminDisputes(req, res, next),
    );
    ...
    this.disputeRouter.get(
      ...
      authMiddleware([Roles.ADMIN], tokenService, authRepository),
      (req, res, next) => injectedDisputeController.getAdminFileAccessUrl(req, res, next),
    );
    ...
    this.disputeRouter.get(
      ...
      authMiddleware([Roles.ADMIN], tokenService, authRepository),
      (req, res, next) => injectedDisputeController.getDisputeDetails(req, res, next),
    );
    ...
    this.disputeRouter.patch(
      ...
      authMiddleware([Roles.ADMIN], tokenService, authRepository),
      (req, res, next) => injectedDisputeController.updateDisputeStatus(req, res, next),
    );
    ...
    this.disputeRouter.post(
      ...
      authMiddleware([Roles.ADMIN], tokenService, authRepository),
      (req, res, next) => injectedDisputeController.enforceModeration(req, res, next),
    );
  }
}

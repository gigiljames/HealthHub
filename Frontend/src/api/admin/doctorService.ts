...
export async function getDoctors(
  ...
  try {
    ...
    const response = await axios.get(`/admin/doctors?${params.toString()}`);
...
export async function blockDoctor(id: string) {
  try {
    const response = await axios.patch(`/admin/doctors/${id}/block`);
...
export async function unblockDoctor(id: string) {
  try {
    const response = await axios.patch(`/admin/doctors/${id}/unblock`);

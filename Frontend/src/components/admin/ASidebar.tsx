  ...
  return (
    <>
      <div
        ...
        } bg-[#363636] flex flex-col gap-3 transition-all duration-200 font-medium `}
      >
        <Link to="/admin/home">
        ...
        <div className="flex flex-col gap-3 overflow-y-auto no-scrollbar">
          ...
          <div>
            ...
            <div className={`flex ${isClosed ? "flex-col" : ""} gap-2 mt-5`}>

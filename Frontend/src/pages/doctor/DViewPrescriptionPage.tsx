...
export const DViewPrescriptionPage: React.FC = () => {
  ...
  return (
    <div className="w-[95%] lg:w-[80%] max-w-[1000px] mx-auto py-8 space-y-6 print:py-0 print:w-full">
      {/* Header / Actions bar */}
      ...
      <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 shadow-lg rounded-3xl overflow-hidden print:border-none print:shadow-none">
        ...
        <div className="p-8 space-y-6">
          ...
          {/* Footer of Rx (Sig) */}
          <div className="pt-8 border-t border-slate-100 dark:border-slate-800/80 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div className="text-xs text-slate-450 space-y-1 max-w-[400px]">

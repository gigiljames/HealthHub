...
function DReviewsPage() {
  ...
  return (
    <div className="flex justify-center w-full min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      <div className="w-[95%] lg:w-[90%] max-w-[1600px] flex flex-col gap-6 py-6 font-sans">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
          ...
          <button
            ...
            className="p-2 hover:bg-slate-205 dark:hover:bg-slate-800 text-slate-500 rounded-xl transition-all border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm cursor-pointer"
            title="Refresh list"
          >

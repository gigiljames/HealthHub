...
export const UViewReportPage: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col font-sans transition-colors duration-300">
      ...
      <div className="w-full max-w-[1100px] mx-auto py-4 sm:py-8 space-y-6 sm:space-y-8 pt-[70px] md:pt-[90px] pb-24 px-0 sm:px-4 md:px-6">
        {/* Header / Actions bar */}
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white flex items-center gap-2">
                <FileCheck className="w-6 h-6 sm:w-7 sm:h-7 text-darkGreen dark:text-emerald-500 animate-pulse" />
                Consultation Report
              </h1>
              <p className="text-xs sm:text-sm text-slate-550 dark:text-slate-400 mt-1 font-semibold">
                Record ID: {report.id}
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-6 sm:gap-8">
          {/* Top Metadata Unit */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white dark:bg-slate-900 border-y sm:border border-slate-100/40 dark:border-slate-900/20 shadow-[0_8px_30px_rgb(0,0,0,0.015)] rounded-none sm:rounded-3xl p-4 sm:p-6 md:p-8">
            {/* Patient summary */}
            <div className="space-y-4">
              ...
              <div>
                <p className="text-xs text-slate-400 dark:text-slate-500 font-bold">Patient Name</p>
                <p className="font-extrabold text-slate-900 dark:text-white text-base sm:text-lg mt-1">
                  {report.patientName || "Sarah Connor"}
                </p>
              </div>
              <div className="pt-4 border-t border-slate-100/40 dark:border-slate-900/30">
                <p className="text-xs text-slate-400 dark:text-slate-500 font-bold">Consultation Date</p>
            ...
            <div className="space-y-4 md:border-l md:border-slate-100/40 dark:md:border-slate-900/30 md:pl-8">
              ...
              <div className="pt-4 border-t border-slate-100/40 dark:border-slate-900/30">
                <p className="text-xs text-slate-400 dark:text-slate-500 font-bold">Specialization</p>
          ...
          {/* Report Content Unit */}
          <div className="bg-white dark:bg-slate-900 border-y sm:border border-slate-100/40 dark:border-slate-900/20 shadow-[0_8px_30px_rgb(0,0,0,0.015)] rounded-none sm:rounded-3xl p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-2.5 sm:space-y-3">
              ...
              <div className="bg-slate-50/50 dark:bg-slate-900/40 p-4 sm:p-5 rounded-xl sm:rounded-2xl border border-slate-100/30 dark:border-slate-900/20">
                <p className="text-sm sm:text-base text-slate-800 dark:text-slate-200 font-bold leading-relaxed">
            ...
            <div className="space-y-2.5 sm:space-y-3">
              ...
              <div className="bg-emerald-500/5 dark:bg-emerald-500/10 p-4 sm:p-5 rounded-xl sm:rounded-2xl border border-emerald-500/10">
                <p className="text-sm sm:text-base text-slate-800 dark:text-slate-100 font-extrabold leading-relaxed">
                  {report.diagnosis}
                </p>
              </div>
            </div>
            ...
            {report.clinicalNotes && (
              <div className="space-y-2.5 sm:space-y-3">
                ...
                <div className="p-4 sm:p-5 bg-slate-50/20 dark:bg-slate-900/20 rounded-xl sm:rounded-2xl border border-slate-100/30 dark:border-slate-900/20">
                  <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-350 leading-relaxed font-medium whitespace-pre-line">
                    {report.clinicalNotes}
                  </p>
                </div>
              </div>
            ...
            {(report.followUpDate || report.followUpNotes) && (
              <div className="pt-5 sm:pt-6 border-t border-slate-100/40 dark:border-slate-900/30 space-y-3 sm:space-y-4">
                <h2 className="text-xs font-extrabold text-amber-600 dark:text-amber-450 uppercase tracking-widest">
                  Follow-up Action Plan
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {report.followUpDate && (
                    <div className="p-4 sm:p-5 bg-amber-500/5 dark:bg-amber-500/10 border border-amber-500/5 dark:border-amber-500/10 rounded-xl sm:rounded-2xl">
                      <p className="text-xs text-amber-700 dark:text-amber-500 font-bold">Planned Return Date</p>
                      <p className="text-sm sm:text-base font-extrabold text-slate-800 dark:text-slate-100 mt-1 flex items-center gap-1.5">
                  ...
                  {report.followUpNotes && (
                    <div className="p-4 sm:p-5 bg-slate-50/40 dark:bg-slate-800/10 border border-slate-100/30 dark:border-slate-900/20 rounded-xl sm:rounded-2xl sm:col-span-1">
                      <p className="text-xs text-slate-400 dark:text-slate-500 font-bold">Instructions</p>
                      <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-350 leading-relaxed mt-1 font-semibold whitespace-pre-line">
                        {report.followUpNotes}
                      </p>
                    </div>
                  )}

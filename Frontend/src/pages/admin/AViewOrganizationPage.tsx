                ...
                <>
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`px-2.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide ${org.organizationType === "HOSPITAL" ? "bg-blue-50 text-blue-650 dark:bg-blue-900/20 dark:text-blue-400" : "bg-purple-50 text-purple-600 dark:bg-purple-900/20 dark:text-purple-400"}`}>
              ...
              <>
                ...
                {org.isBlocked && (
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/30 p-4 rounded-xl flex items-center gap-3 text-red-700 dark:text-red-400 text-sm font-semibold">
                    <svg className="w-5 h-5 text-red-650 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                <div className="bg-white dark:bg-[#252831] p-5 rounded-lg border border-gray-100 dark:border-gray-800 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button
                      ...
                      disabled={isSubmittingAction}
                      className={`py-2.5 px-6 text-xs font-bold rounded-md border transition-all disabled:opacity-50 ${
                        org.isBlocked
                    ...
                    <div className="relative pl-6 border-l border-gray-200 dark:border-gray-700 space-y-6 ml-2">
                      {org.submissionHistory.map((item: any, idx: number) => (
                        <div key={idx} className="relative">
                          {/* Timeline dot */}
                          <span className={`absolute -left-[31px] top-1 w-3.5 h-3.5 rounded-full border-2 border-white dark:border-[#252831] ${
